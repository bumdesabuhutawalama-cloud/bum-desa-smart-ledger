...
export const ACCOUNT_LOOKUPS: Record<string, LookupRule> = {
  ...
  KAS_USP: { prefix: ["1.1.01."], nameIncludes: ["USP"] },
  PIUTANG_USAHA: { prefix: ["1.1.03.01"] },
  PIUTANG_PINJAMAN: { prefix: ["1.1.03.03"], nameIncludes: ["Piutang Pinjaman"] },
  PENYISIHAN_PIUTANG: { prefix: ["1.1.04.01"], nameIncludes: ["Penyisihan Piutang"] },
  CADANGAN_KERUGIAN_PIUTANG: { prefix: ["1.1.04.03"], nameIncludes: ["Cadangan Kerugian Piutang"] },
  PERSEDIAAN_DAGANG: { prefix: ["1.1.05.01"] },
  PENDAPATAN_BUNGA: { nameIncludes: ["bunga"], tipe_akun: ["PENDAPATAN", "PENDAPATAN_LAIN"] },
  PENDAPATAN_DENDA: { nameIncludes: ["denda"], tipe_akun: ["PENDAPATAN", "PENDAPATAN_LAIN"] },
