    ...
    >
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <ModuleCard
          ...
          onClick={() => navigate({ to: "/unit/pangan/transaksi" as any })}
        />
        <ModuleCard
          ...
          onClick={() => navigate({ to: "/unit/pangan/persediaan" as any })}
        />
        <ModuleCard
          ...
          onClick={() => navigate({ to: "/unit/pangan/laporan" as any })}
        />
        <ModuleCard
          title="Kelola Jurnal"
          ...
          onClick={() => navigate({ to: "/unit/pangan/jurnal" as any })}
        />
        <ModuleCard
          title="Kas & Bank"
          ...
          onClick={() => navigate({ to: "/unit/pangan/kas-bank" as any })}
        />
        <ModuleCard
          ...
          onClick={() => navigate({ to: "/unit/pangan/transfer" as any })}
        />
      </div>
    </UnitLayout>
  );
